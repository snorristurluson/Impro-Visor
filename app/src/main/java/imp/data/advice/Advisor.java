...
//					old	    else if( inFamily(chordForm.getFamily(), CcellChord) || extensions.member(CcellChord) )
        ...
        if (flavor == 2) { // Returning EMPTY BAD
...
//                lickForm.getProfileNumber());
                    ...
                    switch (flavor) {
                        case PLAIN_LICK:
                            advice = new AdviceForLick(transposedLickName,
                                    serial,
                                    notes,
                                    chord1root,
                                    key,
                        ...
                        case QUOTE_LICK:
                            advice = new AdviceForQuote(transposedLickName,
                                    serial,
                                    notes,
                                    chord1root,
                                    key,
                        ...
                        case BRICK_LICK:
                            advice = new AdviceForBrick(transposedLickName,
                                    serial,
                                    notes,
                                    chord1root,
                                    key,
                        ...
                        default:
                            ErrorLog.log(ErrorLog.WARNING, "Inappropriate lick flavor: " + flavor);
                    }
