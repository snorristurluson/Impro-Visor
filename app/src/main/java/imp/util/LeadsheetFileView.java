...
public class LeadsheetFileView extends FileView {
    ImageIcon leadsheetIcon = new ImageIcon(getClass().getResource("/graphics/icons/leadsheet.png"));
    ImageIcon styleIcon = new ImageIcon("src/graphics/icons/goodpattern.png");
