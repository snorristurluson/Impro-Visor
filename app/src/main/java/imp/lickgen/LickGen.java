...
//  }
    ...
    public Note getTrueRoot(Note base, int inversion) {
        ...
        switch (inversion) {
            case 4:
                trueSetPitch(trueRoot, base.getPitch());
                break;
            case 3:
                trueSetPitch(trueRoot, base.getPitch());
                break;
            case 2:
                trueSetPitch(trueRoot, base.getPitch() + 5);
                break;
            case 1:
    ...
    public Note[] makeTriad(Note base, int inversion) {
        ...
        do {
            ...
            switch (newInversion2) {
                ...
                case 10:
                    ...
                    break;
                default:
                    System.out.println("default in newInversion2 switch");
                    break;
            }
        ...
        switch (newInversion) {
            ...
            default:
                System.out.println("default case: newInversion = " + newInversion);
        }
