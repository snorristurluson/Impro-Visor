...
//    }
    ...
    private class CriticTableModel extends AbstractTableModel {
        private ImageIcon playIcon = new ImageIcon(getClass().getResource("/graphics/icons/play.png"));
        private ImageIcon loadIcon = new ImageIcon(getClass().getResource("/graphics/icons/load.png"));
